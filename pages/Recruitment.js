...
const Recruitment = () => {
    return (
        ...
        <section className='back2 pb-20'>
            ...
            {/* <Card.Group style={{ marginTop: 40, display: "flex", flexDirection: "row",flexWrap:"wrap", justifyContent: "space-between", alignItems: "center",paddingBottom:80 }}>
                ...
                <CardComponent link="https://docs.google.com/forms/d/e/1FAIpQLSeTKkbPJHOUBXRtarosYFwaepYn0sVXJV4Yebm5ChbK3xbDJA/viewform" image={gd} desc="If you are mad about making short timed arts with low labor and high creative mentality then we people are specifically waiting for you and we'll  be happy enough to include you in our Inside family." position="Graphics Designer" />
                <CardComponent link="https://docs.google.com/forms/d/e/1FAIpQLScD8eAfEdU1nLACXoDHk-nG3LQOB6ftSE-ZBn5FBnJW9Weo_Q/viewform" image={pr} desc="Face of the team with good communication skills and public dealing." position="Public Relations" />
